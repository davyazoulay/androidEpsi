...
namespace ws_sportFounder.PropertiesManager
{
    public class Properties
    {
        ...
        private static String filenameRecOnServeur = @"C:\\inetpub\\wwwroot\\WS_IM_OUT_REC\\PropertiesManager\\PropertiesFiles\\Properties.txt";
        private static String filenameDevLocal = @"C:\Users\Davy.Azoulay\Documents\AppAndroid\ws_sportFounder\ws_sportFounder\PropertiesManager\PropertiesFiles\Properties.txt";
        ...
        public Properties()
        {
            if (System.IO.File.Exists(filenameRecOnServeur))
            {
